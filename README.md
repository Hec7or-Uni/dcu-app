# next-fs-template [![Production CI](https://github.com/Hec7or-Uni/dcu-app/actions/workflows/production.yml/badge.svg)](https://github.com/Hec7or-Uni/dcu-app/actions/workflows/production.yml)
